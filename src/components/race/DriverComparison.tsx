...
interface RadarChartDataPoint {
  attribute: string;
  [driverName: string]: string | number; // attribute is string, driver values are numbers
}
...
const DriverComparison: React.FC<DriverComparisonProps> = ({ data, className, delay = 0 }) => {
    ...
    >
      ...
      <ResponsiveContainer width="100%" height={400}>
        <RadarChart cx="50%" cy="50%" outerRadius="80%" data={data}>
          ...
          <PolarAngleAxis
            dataKey="attribute"
            tick={{ fill: 'rgba(255,255,255,0.7)', fontFamily: 'Geist' }}
          />
          <PolarRadiusAxis
