...
import { ArrowRight01Icon, UserGroupIcon, Message01Icon } from 'hugeicons-react';
...
const DiscordCommunityBanner: React.FC<DiscordCommunityBannerProps> = ({ className }) => {
  return (
    <div
      className={cn(
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
        ...
        <div className="flex-1">
          ...
          <p className="text-gray-300 mb-3">
            Connect with other F1 fans, discuss races, share analysis, and get the latest updates
            from the Fastlytics team. We're building a community of passionate Formula 1 fans who
            love data.
          </p>

          <div className="flex flex-wrap gap-4 mt-2">
            <div className="flex items-center gap-2 bg-gray-800/70 px-3 py-1.5 rounded-md border border-gray-700/50">
              <UserGroupIcon className="h-4 w-4 text-red-400" />
              <span className="text-gray-200 text-sm">100+ Members</span>
            </div>
            <div className="flex items-center gap-2 bg-gray-800/70 px-3 py-1.5 rounded-md border border-gray-700/50">
              <Message01Icon className="h-4 w-4 text-red-400" />
            ...
            >
              Join now <ArrowRight01Icon className="ml-1.5 h-3.5 w-3.5" />
            </a>
          </div>
        </div>
      </div>
