...
const seasonalDriverColorMap: { [year: string]: { [driverCode: string]: string } } = {
  ...
  '2023': {
    ...
    DEV: '#5E8FAA',
    RIC: '#5E8FAA',
    LAW: '#5E8FAA', // Added RIC/LAW for mid-season
    // Williams
    ALB: '#37BEDD',
    SAR: '#37BEDD',
  },
  '2024': {
    ...
    ALB: '#00A3E0',
    SAR: '#00A3E0',
    COL: '#00A3E0', // Colapinto replaced Sargeant
    // RB (Visa Cash App RB)
    RIC: '#4E7C9B',
    TSU: '#4E7C9B',
    LAW: '#4E7C9B', // Lawson replaced Ricciardo
    ...
    HUL: '#B6BABD',
    MAG: '#B6BABD',
    BEA: '#B6BABD', // Bearman (1 race)
  },
  // 2025 placeholder
  '2025': {
    // Based on known 2025 lineup
    // Red Bull Racing
    VER: '#4781D7',
    TSU: '#4781D7', // Assuming RB colors similar to 2022/23
    // Mercedes
    RUS: '#6CD3BF',
    ANT: '#6CD3BF', // Antonelli
    // Ferrari
    LEC: '#FF2800',
    HAM: '#FF2800', // Hamilton (Using recent Ferrari red)
    // McLaren
    NOR: '#FF8700',
    PIA: '#FF8700', // Using recent McLaren orange
    // Aston Martin
    ALO: '#00594F',
    STR: '#00594F', // Using recent Aston green
    // Alpine
    GAS: '#0090FF',
    DOO: '#0090FF',
    COL: '#0090FF', // Doohan (Using recent Alpine blue)
    // Williams
    ALB: '#00A3E0',
    SAI: '#00A3E0', // Sainz (Using recent Williams blue)
    // RB (Visa Cash App RB)
    HAD: '#4E7C9B',
    LAW: '#4E7C9B', // Lawson (Using recent AT/RB blue)
    // Sauber (Using Sauber green)
    HUL: '#52E252', // Hulkenberg
    BOR: '#52E252', // Bortoleto
    // Haas
    OCO: '#B6BABD', // Ocon
    BEA: '#B6BABD', // Bearman
  },
  '2026': {
    ...
    LIN: '#6692FF', // Lindblad
    // Audi
    HUL: '#00E701', // Hulkenberg
    BOR: '#00E701', // Bortoleto
    // Cadillac
    BOT: '#C6A664', // Bottas
    PER: '#C6A664', // Perez
    // Haas
...
export const driverColor = (driverCode: string, season: number | string): string => {
  ...
  // Fallback 2: Check any other year for the same driver code
  for (const y in seasonalDriverColorMap) {
    if (seasonalDriverColorMap[y][driverCode]) {
      return seasonalDriverColorMap[y][driverCode];
    }
  }

  // Fallback 3: Cycle through default colors if no mapping exists in specific or latest year
